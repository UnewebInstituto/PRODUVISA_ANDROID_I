...
// Dependencia para hacer el llamado a la 2da. Actividad.
import android.content.Intent; // Importar Intent
// Dependencia para los controles de la Actividad.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToSecondActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Crear un Intent que hace el llamado a la segunda actividad
